 ...
 * Timer_Services.c
 *
 * Created: 12/20/2020 10:50:03 PM
 *  Author: Ahmed Ashraf
 */ 
...
u8 PMW_GetRead(u32* Pfreq,u8* Pduty)
{
	u16 Ton,Toff;
	if (flag==3)
	{
...
static u32 NofOverFlow=0; //gobal varible because ill need it in another fun
void Timer1_SetInterruptTime_s(u16 time , void(*LocalFptr)(void))
{
		Timer1_Init(TIMER1_FASTPWM_ICR_TOP_MODE,TIMER1_SCALER_8);
		OCR1A = 999; //CTC interrupt kol 1000
